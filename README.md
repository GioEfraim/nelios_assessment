...
**WP credentials:** User `admin` / Pass `adminadmin123` — complete the WP installer on first visit, then activate **Nelios Items** under Plugins.
...
`wordpress/plugins/nelios-items` = CPT + REST · `nextjs` = App Router UI
